...
<body>
  ...
  <script>
    ...
    const SURAHS = [
      ...
      {id:84, name:"Al-Insyiqaq", arabic:"الانشقاق", verses:25, 
    /* Header */
    .header {
      position: sticky;
      top: 0;
    ...
    .ayah-card.playing {
      border-color: var(--accent);
      box-shadow: 0 0 0 1px var(--accent), 0 8px 24px rgba(201, 162, 39, 0.12);
    }
